...
});content: 'Voce esta analisando um comprovante de PIX. Todo PIX tem um DESTINATARIO (quem recebeu o dinheiro). Leia com atencao o campo "Destinatario", "Favorecido", "Recebedor" ou "Para" no comprovante — esse e o nome que voce deve retornar. NUNCA invente um nome. NUNCA use "Di Casa Gastronomia" — esse e o pagador (quem enviou). Texto do comprovante: "' + analise + '". Retorne APENAS JSON valido: {"valor":0.00,"descricao":"nome EXATO do destinatario/favorecido/recebedor como aparece no comprovante","destinatario":"mesmo nome","categoria":"escolha UMA: 👥 RH / Mão de Obra (diaria/salario/freelancer/diarista/funcionario), 🥩 Matéria Prima (alimento/insumo/carne/hortifruti/pao), 🔧 Manutenção, 💡 Energia / Utilidades (luz/agua/gas), 🚚 Frete / Entregador (entrega/motoboy/frete/delivery), 🏢 Aluguel / Fixos, 📦 Embalagem, 🍺 Bebidas / Bar (APENAS se for fornecedor de bebidas), 🧹 Limpeza / Higiene, 💳 Taxas / Impostos, 📱 Telecom / Internet, 🎤 Shows / Eventos, 📣 Marketing, ⚠️ Extravio / Perda, 🔄 Outros","tipo":"pix|boleto|dinheiro|cartao","data":"DD/MM/YYYY (data do comprovante — nao de hoje)","setor":"Restaurante|Pizzaria|Espetaria|Hamburgueria|Geral (qual setor se beneficia — se nao souber use Geral)"}. Se nao tiver valor retorne {"valor":0}';
