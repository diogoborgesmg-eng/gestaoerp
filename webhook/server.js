    ...
    try {
      ...
      if (['imageMessage','documentMessage'].includes(tipo)) {
        ...
        const r1 = await claude([{ role:'user', content:[
          ...
          { type:'text', text:'Leia este comprovante PIX/pagamento e retorne APENAS um JSON valido, sem texto adicional.\n\nREGRA IMPORTANTE: Di Casa Gastronomia ou Di Casa Laranjinha e SEMPRE o PAGADOR (quem enviou o dinheiro). O nome que voce deve retornar em descricao e de quem RECEBEU — procure nos campos: Favorecido, Para, Destinatario, Recebedor, Nome do Recebedor, Beneficiario. Se aparecer apenas Di Casa, leia com mais atencao o recibo pois o nome do recebedor SEMPRE aparece.\n\nRetorne APENAS este JSON:\n{"valor":0.00,"descricao":"NOME COMPLETO de quem recebeu o pagamento (nao Di Casa)","categoria":"escolha: 👥 RH / Mão de Obra|🥩 Matéria Prima|🔧 Manutenção|💡 Energia / Utilidades|🚚 Frete / Entregador|🏢 Aluguel / Fixos|📦 Embalagem|🍺 Bebidas / Bar|🧹 Limpeza / Higiene|💳 Taxas / Impostos|📱 Telecom / Internet|🎤 Shows / Eventos|📣 Marketing|⚠️ Extravio / Perda|🔄 Outros","tipo":"pix","data":"DD/MM/YYYY","setor":"Restaurante|Pizzaria|Espetaria|Hamburgueria|Geral"}' }
        ]}], 500);
